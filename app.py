...
# ======================== PAGE CONFIGURATION ========================
st.set_page_config(
    page_title="Weedy Rice and Cultivated Rice Detection",
    page_icon="🌾",
    layout="wide",
...
# ======================== TOP BANNER & HEADER ========================
st.title("🌾 Weedy Rice and Cultivated Rice Detection Using YOLOv8")
st.markdown("---")
        ...
        try:
            if source_img is None:
                ...
                st.image(source_img, caption="Uploaded Image",
                        use_container_width=True)  # Removed className
        except Exception as ex:
